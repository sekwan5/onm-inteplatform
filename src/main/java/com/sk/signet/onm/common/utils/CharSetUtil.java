 ...
 *
 * <p>
 * This class handles <code>null</code> input gracefully.
...
public class CharSetUtil {
    ...
    /**
     * <p>
     * 모든 메소드가 static이기 때문에 <code>CharSetUtil</code> 인스탄스는
     * 일반적으로 필요하지 않음.<br>
     * 대신 아래와 같이 사용하면 됨.<br>
     ...
     *
     * @deprecated 가급적 {@link StringUtil#replaceChars(String, String, String)}를 이용할
     *             것.
     */
    @Deprecated
