...
/**
 * <p>
 * 자바 기본데이터 타입(<code>int[]</code>와 같은)의 배열에 대한
 * 보조기능(<code>Integer[]</code>와 같은)을 제공하는 유틸리티 클래스
 * </p>
 * 
 * <p>
 * 다음과 같은 기능을 제공한다.
 ...
 * @author Gary Gregory
 * @since 2.0
 * @version $Id: ArrayUtil.java,v 1.1 2009/04/07 10:45:23 since88 Exp $
 */
public class ArrayUtil {
    ...
    /**
     * <p>
     * 모든 메소드가 static이기 때문에 <code>ArrayUtil</code> 인스탄스는
     * 일반적으로 필요하지 않음.<br>
     * 대신 아래와 같이 사용하면 됨.<br>
     ...
     * </p>
     * 
     * @param array 문자열로 변환할 대상 배열, <code>null</code>도 가능함.
     ...
     * 
     * @param array        문자열로 변환할 대상 배열, <code>null</code>도 가능함.
     * @param stringIfNull 배열이 <code>null</code>일 경우 반환할 값
     ...
     * </p>
     * 
     * @param array the array to get a hashCode for, <code>null</code>도 가능함.
     ...
     * </p>
     * 
     * @param array1 비교할 배열 1, <code>null</code>도 가능함.
     * @param array2 비교할 배열 2, <code>null</code>도 가능함.
     ...
     * array
     * must be either a {@link java.util.Map.Entry} or an Array, containing at least
     * two
     ...
     *
     * <p>
     * A negative startIndex will return <code>-1</code>. A startIndex larger than
     * the array 시작 인덱스가 배열의 길이보다 크다면 끝에서 부터 찾는다.
     * 
     * @param array        대상 배열, <code>null</code>도 가능함.
     * @param objectToFind 찾고자 하는 값, <code>null</code>도 가능함.
     ...
     * [valueToFind - tolerance < 찾을 값 < valueToFind + tolerance] 을 만족하는 값을 리턴한다.
     ...
     *
     * <p>
     * The method returns <code>false</code> if <code>null</code> array
     * is passed in.
     * </p>
     *
